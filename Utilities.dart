...
//   // Create a DateTime object represnting an earlier date
//   DateTime parsedDate = DateTime.parse('2024-04-05');

//   // Format the current date to 'yyyy-MM-dd' format
//   // 2024-03-28
//   String formattedDate = '${now.year}-${_addLeadingZero(now.day)}';
...
//   print('Formatted Date is: $formattedTime');

//   // Pront the future date
